...
const rawData = [
  ...
  { code: "001757", name: "Centro De Salud Atahualpa", type: "CENTRO DE SALUD TIPO A", district: "17D03", parish: "Atahualpa (Habaspamba)", schedule: "8:00 - 14:00", day: "Sabado Cada 15 Dias" },
  ...
  { code: "001638", name: "La Magdalena", type: "CENTRO DE SALUD TIPO B", district: "17D06", parish: "La Magdalena", schedule: "8:00 - 16:00", day: "Lunes Mieroles Y Viernes" },
  { code: "001639", name: "Atahualpa", type: "CENTRO DE SALUD TIPO A", district: "17D06", parish: "La Magdalena", schedule: "8:00 - 16:00", day: "Jueves" },
  ...
  { code: "001655", name: "Hierba Buena 2", type: "CENTRO DE SALUD TIPO A", district: "17D06", parish: "La Argelia", schedule: "8:00 - 16:00", day: "Nueves" },
  ...
  { code: "002840", name: "Centro De Salud Tipo A Yaruqui", type: "CENTRO DE SALUD TIPO A", district: "17D06", parish: "Yaruqui", schedule: "9:00 - 15:00", day: "Lunes" },
  { code: "002992", name: "Mangahuantag", type: "PUESTO DE SALUD", district: "17D06", parish: "Puembo", schedule: "8:00 - 14:00", day: "Martes" }
];

const Modal = ({ center, onClose }) => {
  if (!center) return null;

  const googleMapsUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(center.name)}+${encodeURIComponent(center.parish)}+Quito`;
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-blue-100 outline-none transition-all text-sm font-medium"
                  value={searchTerm}
